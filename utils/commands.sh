minimap2 -a DHPS.fasta fastq_files/ML_test_mix2.fastq > alignment.sam
...
gunzip -c minimap_samtools_out.fastq.gz | chopper -q 17 --minlength 642 --maxlength 1000 | gzip > filtered_reads.fastq.gz
gunzip filtered_reads.fastq.gz

minimap2 -a DHPS.fasta filtered_reads.fastq > alignment2.sam
